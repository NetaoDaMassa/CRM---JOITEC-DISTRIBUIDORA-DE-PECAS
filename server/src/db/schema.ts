...
export const clientes = sqliteTable('clientes', {
  ...
  // Nulo pra cliente cadastrado sem estado conhecido (ex: carga de Restrição
  // de Crédito, 2026-09-24 — só tinha CNPJ/razão social, sem cidade/UF) —
  // antes era obrigatória, mas exigir "chutar" uma região pra quem não tem
  // esse dado é pior que deixar em branco até alguém completar de verdade.
  regiao: text('regiao', {
    enum: ['norte', 'nordeste', 'centro_oeste', 'sudeste', 'sul'],
  }),
  estado: text('estado'),
