// ⚠️ TEMPORÁRIO — cópia de server/scripts/configurar-metas-e-sergio-odin-tubos.ts
...
import { clientes, empresas, metasMensais, users } from '../db/schema.js'
import { mesReferenciaAtual } from '../lib/dataBr.js'
import { setConfig } from '../lib/configuracoes.js'
