...
import RestricaoCredito from './pages/admin/RestricaoCredito'
...
import CalendarioOdin from './pages/CalendarioOdin'
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="admin/restricao-credito" element={<AdminGuard><FeatureGuard feature="restricao_credito"><RestricaoCredito /></FeatureGuard></AdminGuard>} />
